...
class MapEntry extends Entry implements MapOptions
{
     ...
     * @param Closure|bool $snappable
     * @param int $distance
     * @return $this
     */
    public function snappable(Closure|bool $snappable = true, int $distance = 20): self
    {
        $this->extraControls['snappable'] = $this->evaluate($snappable);
    ...
    {
        $this->extraControls['drawRectangle'] = $this->evaluate($draw);
        return $this;
    }
    ...
    {
        $this->extraControls['drawText'] = $this->evaluate($draw);
        return $this;
    }
